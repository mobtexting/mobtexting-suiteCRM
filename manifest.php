...
$manifest = array(
    ...
    'name'                      => 'MOBtexting SMS',
    'published_date'            => 'February 10, 2021',
    'type'                      => 'module',
    'version'                   => 'v0.0.1',
...
$installdefs = array(
    ...
    'logic_hooks'    => array(
        ...
        array(
            ...
            'hook'        => 'before_save',
            'order'       => 101,
            'description' => 'Contacts Auto SMS',
            'file'        => 'modules/MOBtexting/MobtextingAutoSMS.php',
            'class'       => 'MobtextingAutoSMS',
            'function'    => 'pushFeed',
        ),
        array(
            'module'      => 'Leads',
